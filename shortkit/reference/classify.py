...
def video_features(preset: str, vid: str) -> dict | None:
    ...
    if caps:
        ...
        from .aggregate import FIRST_CAPTION_EXCLUDED_ROLES   # one definition (aggregate imports this module)

        timed = [c for c in items if c["role"] not in FIRST_CAPTION_EXCLUDED_ROLES]
