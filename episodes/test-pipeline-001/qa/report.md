...
- 측정 대상: `episodes/test-pipeline-001/output/test-pipeline-001.mp4` (sha256 `56f4a76ce53947bc…`, 1080x1920, 19.27s)
- 원칙: 최종 MP4 만 측정(타임라인/코드가 맞다고 출력이 맞다고 보지 않음)
- 프리셋: joshuamagazine-v1 / 포맷 UNCLASSIFIED / 모드 **test**
- 레퍼런스: 없음(못 잼)
- 측정 시각: 2026-09-25T02:19:04+00:00 / 도구: OCR=5.3.4, 얼굴검출=shortkit.clean.faces haar frontal+profile (shortkit.HaarCascade(numpy))

## 최종 관문: **불합격**
- ✗ G2: 필수 항목 못 잼 1건 — 못 잼은 완료가 아님 — caption.font:role_description
- △ P1: 프리셋 미측정(임시값) 키 255개
- △ P2: 레퍼런스 대비 못 잼 53건
- △ P3: 테스트 모드 출력(파이프라인 검증용) — 게시 불가

## 요약
- 전체 219행: 같다 158 / 다르다 0 (의도한 변경 0, 의도하지 않음 0) / 못 잼 61
- 계획 대비(출력이 계획대로인가): {'same': 158, 'unmeasured': 8}
...
| 자막 크기 [speaker] (레퍼런스 대비) | 못 잼 | {"text.roles.speaker.size_px":40,"text.roles.speaker.max_lines":1,"text.roles.speaker.max… | {"size_px_est":40.0} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 3개: text.roles.speaker.size_px, text.roles.speaker.ma… |
...
| 자막 색·외곽선·박스 [dialogue] (레퍼런스 대비) | 못 잼 | {"text.roles.dialogue.color":"#FFE400","text.roles.dialogue.outline_px":6,"text.roles.dia… | {"fill_color":"#FDE300"} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 5개: text.roles.dialogue.color, text.roles.dialogue.ou… |
...
| 자막 색·외곽선·박스 [situation] (레퍼런스 대비) | 못 잼 | {"text.roles.situation.color":"#FFFFFF","text.roles.situation.highlight_color":"#FFE400",… | {"fill_color":"#FFFFFF"} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 6개: text.roles.situation.color, text.roles.situation.… |
| 자막 색·외곽선·박스 [speaker] (레퍼런스 대비) | 못 잼 | {"text.roles.speaker.color":"#FFFFFF","text.roles.speaker.outline_px":0,"text.roles.speak… | {"fill_color":"#FFFFFF"} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 8개: text.roles.speaker.color, text.roles.speaker.outl… |
...
| 항목 | 레퍼런스 | 기대 | 출력 측정 | 판정(같다/다르다/못 잼) | 의도한 변경 | 근거 |
|---|---|---|---|---|---|---|
| 자막 글꼴 [c_title·title] "움직임 테스트 영상" (자막 1개·정지 프레임 1장, 참고) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9883,"margin":0.0727,"top":"Not… | 같다 (참고) | 아니오 | t=0.12s [프레임](frames/cap_c_title_0000120.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_desc·description] "파이프라인 검증용 합성 샘플" (자막 1개·정지 프레임 … | 못 잼 | Noto Sans CJK KR Bold | {"verdict":"similar","verdict_ko":"유사(동일 확정 불가)","iou_expected":0.9511,"margin":0.0573,"t… | 못 잼 (참고) | 아니오 | t=0.32s [프레임](frames/cap_c_desc_0000320.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_spk·speaker] "창가 남성" (자막 1개·정지 프레임 1장, 참고) | 못 잼 | Noto Sans CJK KR Bold | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9587,"margin":0.0532,"top":"Not… | 같다 (참고) | 아니오 | t=0.57s [프레임](frames/cap_c_spk_0000570.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_sit1·situation] "창가 남성이 일어선다" (자막 1개·정지 프레임 1장, 참고) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9729,"margin":0.0531,"top":"Not… | 같다 (참고) | 아니오 | t=1.54s [프레임](frames/cap_c_sit1_0001540.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_sit2·situation] "다시 자리에 앉는다" (자막 1개·정지 프레임 1장, 참고) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9701,"margin":0.0621,"top":"Not… | 같다 (참고) | 아니오 | t=4.34s [프레임](frames/cap_c_sit2_0004340.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_sit3·situation] "뒷줄 남성이 손을 든다" (자막 1개·정지 프레임 1장, 참… | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9634,"margin":0.0513,"top":"Not… | 같다 (참고) | 아니오 | t=7.94s [프레임](frames/cap_c_sit3_0007940.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_dlg·dialogue] ""저기 봐, 들어온다!"" (자막 1개·정지 프레임 1장, 참고) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9622,"margin":0.1321,"top":"Not… | 같다 (참고) | 아니오 | t=10.22s [프레임](frames/cap_c_dlg_0010219.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_rx·reaction] "갸우뚱?" (자막 1개·정지 프레임 1장, 참고) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected":0.9802,"margin":0.0842,"top":"Not… | 같다 (참고) | 아니오 | t=15.32s [프레임](frames/cap_c_rx_0015319.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [c_sit4·situation] "두 사람이 고개를 기울인다" (자막 1개·정지 프레임 1장,… | 못 잼 | Noto Sans CJK KR Black | {"verdict":"similar","verdict_ko":"유사(동일 확정 불가)","iou_expected":0.9686,"margin":0.0532,"t… | 못 잼 (참고) | 아니오 | t=15.34s [프레임](frames/cap_c_sit4_0015339.png) 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_… |
| 자막 글꼴 [description] (역할 단위: 자막 1개의 정지 프레임 합동) | 못 잼 | Noto Sans CJK KR Bold | {"verdict":"similar","verdict_ko":"유사(동일 확정 불가)","iou_expected_median":0.9511,"iou_stats"… | 못 잼 | 아니오 | t=0.33s 판정: 유사(similar, 동일 확정 불가) — 같다고 쓰지 않음. IoU 0.951 < 천장 p10 0.955; 차순위 … |
| 자막 글꼴 [dialogue] (역할 단위: 자막 1개의 정지 프레임 합동) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected_median":0.9622,"iou_stats":{"n":4,… | 같다 | 아니오 | t=10.23s 판정: 동일(identical) — IoU 0.962 >= 천장 p10 0.961; 차순위 대비 차이 +0.132 > 잡음 … |
| 자막 글꼴 [reaction] (역할 단위: 자막 1개의 정지 프레임 합동) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected_median":0.981,"iou_stats":{"n":4,"… | 같다 | 아니오 | t=15.33s 판정: 동일(identical) — IoU 0.981 >= 천장 p10 0.972; 차순위 대비 차이 +0.084 > 잡음 … |
| 자막 글꼴 [situation] (역할 단위: 자막 4개의 정지 프레임 합동) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected_median":0.9694,"iou_stats":{"n":16… | 같다 | 아니오 | t=1.57s 판정: 동일(identical) — IoU 0.969 >= 천장 p10 0.968; 차순위 대비 차이 +0.057 > 잡음 … |
| 자막 글꼴 [speaker] (역할 단위: 자막 1개의 정지 프레임 합동) | 못 잼 | Noto Sans CJK KR Bold | {"verdict":"identical","verdict_ko":"동일","iou_expected_median":0.9587,"iou_stats":{"n":4,… | 같다 | 아니오 | t=0.60s 판정: 동일(identical) — IoU 0.959 >= 천장 p10 0.951; 차순위 대비 차이 +0.053 > 잡음 … |
| 자막 글꼴 [title] (역할 단위: 자막 1개의 정지 프레임 합동) | 못 잼 | Noto Sans CJK KR Black | {"verdict":"identical","verdict_ko":"동일","iou_expected_median":0.9882,"iou_stats":{"n":4,… | 같다 | 아니오 | t=0.13s 판정: 동일(identical) — IoU 0.988 >= 천장 p10 0.980; 차순위 대비 차이 +0.073 > 잡음 … |
| 자막 글꼴 [description] (레퍼런스 대비) | 못 잼 | {"text.roles.description.font_name":"Noto Sans CJK KR Bold","text.roles.description.bold"… | — | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 2개: text.roles.description.font_name, text.roles.desc… |
...
| 항목 | 레퍼런스 | 기대 | 출력 측정 | 판정(같다/다르다/못 잼) | 의도한 변경 | 근거 |
|---|---|---|---|---|---|---|
| 자막 등장·퇴장 시각 [c_title·title] "움직임 테스트 영상" | 못 잼 | {"start":0.0,"end":19.25} | {"onset":0.0,"offset":19.2667} | 같다 | 아니오 | t=0.00s [프레임](frames/cap_c_title_0000120.png) |
...
| 자막 표시 시간 [dialogue] (레퍼런스 대비) | 못 잼 | {"text.roles.dialogue.timing.lead_s":0.0,"text.roles.dialogue.timing.min_dur_s":0.8,"text… | {"min_dur_s":2.2,"first_onset":10.1,"last_offset":12.3,"duration":19.267} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 3개: text.roles.dialogue.timing.lead_s, text.roles.dia… |
...
| 자막 등장·퇴장 모션 [dialogue] (레퍼런스 대비) | 못 잼 | {"text.roles.dialogue.motion_in.type":"none","text.roles.dialogue.motion_out.type":"none"} | {"type":"none"} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 2개: text.roles.dialogue.motion_in.type, text.roles.di… |
...
| 자막 등장·퇴장 모션 [speaker] (레퍼런스 대비) | 못 잼 | {"text.roles.speaker.motion_in.type":"fade","text.roles.speaker.motion_in.dur_s":0.15,"te… | {"type":"fade"} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 4개: text.roles.speaker.motion_in.type, text.roles.spe… |
...
| 항목 | 레퍼런스 | 기대 | 출력 측정 | 판정(같다/다르다/못 잼) | 의도한 변경 | 근거 |
|---|---|---|---|---|---|---|
| BGM 곡·버전 일치(파형 대조) | 못 잼 | {"path":"assets/test/generated/music_bed_a.wav","track_id":null} | {"presence":"present","waveform_ncc":0.8439,"local_match":{"n":76,"q95":0.9999,"q70":0.99… | 같다 | 아니오 | 출력 믹스에서 계획한 음악 파일의 파형을 찾음 ／ is_match 4요소: 곡=같다, 버전=같다, 속도=같다, 구간=같다 |
...
| BGM 속도(버전) | 못 잼 | 1.0 | 1.0 | 같다 | 아니오 | 후보 템포 상위: [[1.0, 0.7685], [1.005, 0.2572], [0.995, 0.2305], [0.99, 0.… |
...
| 보존 대사 구간의 BGM 덕킹 | 못 잼 | {"duck_ranges":[[10.0,12.3]],"depth_db":10.0} | {"ducked_ranges":[[9.945,12.444],[18.791,19.241]],"coverage":[1.0]} | 같다 | 아니오 | t=10.00s |
...
| 덕킹 깊이 | 못 잼 | {"depth_db":-10.0} | {"depth_db":-10.01} | 같다 | 아니오 | — |
| 덕킹 깊이·속도 (레퍼런스 대비) | 못 잼 | {"audio.ducking.depth_db":10.0,"audio.ducking.attack_s":0.08,"audio.ducking.release_s":0.… | {"depth_db":-10.01} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 3개: audio.ducking.depth_db, audio.ducking.attack_s, a… |
...
| 항목 | 레퍼런스 | 기대 | 출력 측정 | 판정(같다/다르다/못 잼) | 의도한 변경 | 근거 |
|---|---|---|---|---|---|---|
| 보존 원음 [s3 10.00–12.30s] | 못 잼 | {"present":true,"applied_gain_db":5.6,"stem":"raw","reason":"소스에 들어 있는 대사 한 줄(합성 TTS)을 살림… | {"presence":"present","present_fraction":1.0,"gain_db_mix_scale":5.48} | 같다 | 아니오 | t=10.00s 원음 이득은 BGM 기준 믹스 척도 추정(BGM 없으면 없음) |
...
| 보존 원음 크기(프로그램 음량 대비) [s3 10.00–12.30s] | 못 잼 | {"rel_lu":0.0,"source":"audio.original.keep_gain_db","definition":"보존 원음 통합 음량 − 프로그램 통합 … | {"rel_lu_obs":0.33,"src_lufs":-19.6,"src_scope":"clip","fit_gain_db":5.23,"n_windows":7,"… | 같다 | 아니오 | t=10.00s L_src(소스 통합 음량) + 출력 믹스 속 원음 이득(창별 최소제곱 중앙값) − 출력 통합 음량 |
...
| 보존 원음 크기·경계 (레퍼런스 대비) | 못 잼 | {"audio.original.keep_gain_db":0.0,"audio.original.fade_s":0.04} | {"rel_lu":0.33} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 2개: audio.original.keep_gain_db, audio.original.fade_… |
...
| 효과음 [fx2·click] 크기 | 못 잼 | {"gain_db":-8.0} | {"gain_db_mix_scale":-8.06,"reference":"bgm_plateau (BGM 없음/정적 구간)"} | 같다 (참고) | 아니오 | t=6.80s |
...
| 항목 | 레퍼런스 | 기대 | 출력 측정 | 판정(같다/다르다/못 잼) | 의도한 변경 | 근거 |
|---|---|---|---|---|---|---|
| 통합 음량(LUFS)·트루피크 | 못 잼 | {"integrated_lufs":-14.0,"true_peak_db":-1.5} | {"integrated_lufs":-14.7,"lra":1.4,"true_peak_db":-1.9} | 같다 | 아니오 | — |
...
| 영상 길이 (레퍼런스 분포 대비) | 못 잼 | {"structure.duration_s.p10":null,"structure.duration_s.p50":null,"structure.duration_s.p9… | {"duration":19.27} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 4개: structure.duration_s.p10, structure.duration_s.p5… |
...
- 자막 글꼴 [c_desc·description] "파이프라인 검증용 합성 샘플" (자막 1개·정지 프레임 1장, 참고) (`caption.font:c_desc`): 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_description 이 한다 — 이 행의 못 잼은 관문을 막지 않지만 '다르다'는 그대로 관문(G1)에 걸린다(한 자막만 다른 글꼴일 수 있음). 판정: 유사(similar, 동일 확정 불가) — 같다고 쓰지 않음. IoU 0.951 < 천장 p10 0.955; 차순위 대비 차이 +0.057 > 잡음 0.039; 글자별 검사 통과 — 제작 영향: 글꼴이 맞는지 확인하지 못함 → 글자 인상이 다를 수 있음
- 자막 글꼴 [c_sit4·situation] "두 사람이 고개를 기울인다" (자막 1개·정지 프레임 1장, 참고) (`caption.font:c_sit4`): 참고 행(필수 아님): 한 crop 의 판정은 잡음이 커서 필수 판정은 역할 단위 합동 행 caption.font:role_situation 이 한다 — 이 행의 못 잼은 관문을 막지 않지만 '다르다'는 그대로 관문(G1)에 걸린다(한 자막만 다른 글꼴일 수 있음). 판정: 유사(similar, 동일 확정 불가) — 같다고 쓰지 않음. IoU 0.969 < 천장 p10 0.971; 차순위 대비 차이 +0.053 > 잡음 0.009; 글자별 검사 통과 — 제작 영향: 글꼴이 맞는지 확인하지 못함 → 글자 인상이 다를 수 있음
- **필수** 자막 글꼴 [description] (역할 단위: 자막 1개의 정지 프레임 합동) (`caption.font:role_description`): 판정: 유사(similar, 동일 확정 불가) — 같다고 쓰지 않음. IoU 0.951 < 천장 p10 0.955; 차순위 대비 차이 +0.057 > 잡음 0.046; 글자별 검사 통과 — 제작 영향: 글꼴이 맞는지 확인하지 못함 → 글자 인상이 다를 수 있음
...
- 자막 색·외곽선·박스 [dialogue] (레퍼런스 대비) (`caption.style:dialogue_ref`): 레퍼런스 미측정(임시값) 키 5개: text.roles.dialogue.color, text.roles.dialogue.outline_px, text.roles.dialogue.outline_color, text.roles.dialogue.shadow_px, text.roles.dialogue.box.enabled — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: box.color — box.enabled=false(박스 없음); box.alpha — box.enabled=false(박스 없음); box.pad_x — box.enabled=false(박스 없음); box.pad_y — box.enabled=false(박스 없음); shadow_color — shadow_px=0(그림자 없음); highlight_color — 이 편의 이 역할 자막에 강조 단어 없음(계획). — 제작 영향: 글자 색 불일치
...
- 자막 표시 시간 [dialogue] (레퍼런스 대비) (`caption.timing:dialogue_ref`): 레퍼런스 미측정(임시값) 키 3개: text.roles.dialogue.timing.lead_s, text.roles.dialogue.timing.min_dur_s, text.roles.dialogue.persist — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 측정한 최소 표시 시간 ≥ timing.min_dur_s − 0.05 s — 제작 영향: 자막 등장 타이밍 불일치
- 자막 등장·퇴장 모션 [dialogue] (레퍼런스 대비) (`caption.motion:dialogue_ref`): 레퍼런스 미측정(임시값) 키 2개: text.roles.dialogue.motion_in.type, text.roles.dialogue.motion_out.type — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: motion_in.dur_s — motion_in.type=none; motion_in.scale_from — motion_in.type=none(pop 아님); motion_in.offset_px — motion_in.type=none(slide 아님); motion_out.dur_s — motion_out.type=none. — 제작 영향: 자막 등장·퇴장 모션 불일치
...
- 자막 색·외곽선·박스 [situation] (레퍼런스 대비) (`caption.style:situation_ref`): 레퍼런스 미측정(임시값) 키 6개: text.roles.situation.color, text.roles.situation.highlight_color, text.roles.situation.outline_px, text.roles.situation.outline_color, text.roles.situation.shadow_px, text.roles.situation.box.enabled — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: box.color — box.enabled=false(박스 없음); box.alpha — box.enabled=false(박스 없음); box.pad_x — box.enabled=false(박스 없음); box.pad_y — box.enabled=false(박스 없음); shadow_color — shadow_px=0(그림자 없음). — 제작 영향: 글자 색 불일치
...
- 자막 크기 [speaker] (레퍼런스 대비) (`caption.size:speaker_ref`): 레퍼런스 미측정(임시값) 키 3개: text.roles.speaker.size_px, text.roles.speaker.max_lines, text.roles.speaker.max_chars_per_line — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: line_spacing — max_lines=1 이고 이 편의 자막도 한 줄(줄 간격이 없음). — 제작 영향: 글자 크기 불일치 → 줄 수·가림 영역 변화
- 자막 색·외곽선·박스 [speaker] (레퍼런스 대비) (`caption.style:speaker_ref`): 레퍼런스 미측정(임시값) 키 8개: text.roles.speaker.color, text.roles.speaker.outline_px, text.roles.speaker.shadow_px, text.roles.speaker.box.enabled, text.roles.speaker.box.color, text.roles.speaker.box.alpha … — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: shadow_color — shadow_px=0(그림자 없음); outline_color — outline_px=0(외곽선 없음); highlight_color — 이 편의 이 역할 자막에 강조 단어 없음(계획). — 제작 영향: 글자 색 불일치
...
- 자막 표시 시간 [speaker] (레퍼런스 대비) (`caption.timing:speaker_ref`): 레퍼런스 미측정(임시값) 키 2개: text.roles.speaker.timing.min_dur_s, text.roles.speaker.persist — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: timing.lead_s — lead_s 는 대사(말소리 대비) 자막에만 적용. 측정한 최소 표시 시간 ≥ timing.min_dur_s − 0.05 s — 제작 영향: 자막 등장 타이밍 불일치
- 자막 등장·퇴장 모션 [speaker] (레퍼런스 대비) (`caption.motion:speaker_ref`): 레퍼런스 미측정(임시값) 키 4개: text.roles.speaker.motion_in.type, text.roles.speaker.motion_in.dur_s, text.roles.speaker.motion_out.type, text.roles.speaker.motion_out.dur_s — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 적용되지 않아 판정에서 뺀 키: motion_in.scale_from — motion_in.type=fade(pop 아님); motion_in.offset_px — motion_in.type=fade(slide 아님). — 제작 영향: 자막 등장·퇴장 모션 불일치
...
- 같은 검사 재확인: test-coverage-001: caption.font=problem
