...
| 자막 색·외곽선·그림자·박스 [c_spk·speaker] "창가 남성" | 못 잼 | {"color":"#FFFFFF","outline_px":0.0,"outline_color":"#000000","box":true,"box_alpha":0.65… | {"fill_color":"#FFFFFF","outline_px":0,"outline_color":"#504E4C","box_alpha":0.645,"highl… | 같다 | 아니오 | t=0.57s [프레임](frames/cap_c_spk_0000570.png) 그림자 못 잼(판정에서 뺌): 박스가 있어 그림자를 따로 재지 않음 |
...
| 자막 색·외곽선·그림자·박스 [c_rx·reaction] "갸우뚱?" | 못 잼 | {"color":"#FFE400","outline_px":7.0,"outline_color":"#000000","box":false,"box_alpha":nul… | {"fill_color":"#FEE300","outline_px":7,"outline_color":"#050000","box_alpha":0.0,"highlig… | 같다 | 아니오 | t=15.32s [프레임](frames/cap_c_rx_0015319.png) 그림자 못 잼(판정에서 뺌): 왼쪽 위(그림자가 없는 쪽)도 배경으로 돌아오지 않음(복잡한 배경/박스) |
...
| 자막 색·외곽선·그림자·박스 [reaction] (레퍼런스 대비) | 못 잼 | {"text.roles.reaction.color":"#FFE400","text.roles.reaction.outline_px":7,"text.roles.rea… | {"fill_color":"#FEE300","outline_px":7.0,"outline_color":"#050000","box_alpha":0.0} | 못 잼 (참고) | 아니오 | 레퍼런스 미측정(임시값) 키 4개: text.roles.reaction.color, text.roles.reaction.ou… |
...
| 말소리 시작 − 대사 자막 등장 (레퍼런스 대비) | 못 잼 | {"text.roles.dialogue.timing.lead_s":0.0} | {"lead_s":-0.103,"per_caption":[{"caption":"c_dlg","onset":10.1,"offset":12.3,"speech_ons… | 못 잼 (참고) | 아니오 | t=10.10s 레퍼런스 미측정(임시값) 키 1개: text.roles.dialogue.timing.lead_s — 출력이 임시값과 같아도 … |
...
- 자막 색·외곽선·그림자·박스 [dialogue] (레퍼런스 대비) (`caption.style:dialogue_ref`): 레퍼런스 미측정(임시값) 키 1개: text.roles.dialogue.color — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 측정한 채움색·외곽선(배경과 구별될 때)·박스 불투명도의 중앙값 + 레퍼런스 분석기와 같은 정의(reference.textboxes.measure_line / box_alpha; 그림자는 레퍼런스와 같은 추정기 shortkit.util.textmeasure.drop_shadow)로 잰 그림자·박스 여백(박스 경계 − 보이는 잉크)·박스 색; 재지 못한 키(어두운 배경의 그림자, 박스가 안 보이는 경우 등)는 행에서 뺌 — 제작 영향: 글자 색 불일치
...
- 말소리 시작 − 대사 자막 등장 (레퍼런스 대비) (`caption.timing:dialogue_lead_ref`): 레퍼런스 미측정(임시값) 키 1개: text.roles.dialogue.timing.lead_s — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 정의(레퍼런스 분석기·렌더러와 같음, reference.textboxes.dialogue_lead): 겹치는 말소리 시작 − 대사 자막 시작(+ = 말보다 먼저 뜸), 둘 다 출력에서 잼(자막 등장 = 문자 검사, 말소리 = 출력 − BGM·효과음의 음성 구간); 허용 ±0.133s — 제작 영향: 자막 등장 타이밍 불일치
...
- 자막 색·외곽선·그림자·박스 [reaction] (레퍼런스 대비) (`caption.style:reaction_ref`): 레퍼런스 미측정(임시값) 키 4개: text.roles.reaction.color, text.roles.reaction.outline_px, text.roles.reaction.outline_color, text.roles.reaction.box.enabled — 출력이 임시값과 같아도 레퍼런스와 같다고 판정하지 않음. 측정한 채움색·외곽선(배경과 구별될 때)·박스 불투명도의 중앙값 + 레퍼런스 분석기와 같은 정의(reference.textboxes.measure_line / box_alpha; 그림자는 레퍼런스와 같은 추정기 shortkit.util.textmeasure.drop_shadow)로 잰 그림자·박스 여백(박스 경계 − 보이는 잉크)·박스 색; 재지 못한 키(어두운 배경의 그림자, 박스가 안 보이는 경우 등)는 행에서 뺌 — 제작 영향: 글자 색 불일치
