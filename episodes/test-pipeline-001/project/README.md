...
- 생성 2026-09-24T20:31:20+00:00 · 프리셋 `joshuamagazine-v1` · 포맷 `UNCLASSIFIED` · 모드 `test` (테스트: 파이프라인 검증용, 게시용 아님)
...
- 전체 음량: 타임라인 volume 필터 -0.07 dB (출처: episodes/test-pipeline-001/build/render_report.json)
- 효과음/원본 소리 안전 리미터: 마스터가 최대 2.928 dB 줄인 것을 `episodes/test-pipeline-001/build/fg_gain.json` 에서 프레임별로 읽어 각 클립 volume 키프레임으로 재현 (마스터 리미터는 샘플 단위, MLT 키프레임은 프레임(1/fps) 단위라 피크 순간은 약간 다를 수 있음)
- 모노 오디오 5개: melt 7.22 는 모노 파일을 스테레오 프로젝트에 채널마다 -3.01 dB 로 올림(이 기계에서 측정: 비 0.70704, L=R); 마스터(shortkit.util.media.read_audio)는 모노를 양쪽 채널에 같은 크기(0 dB)로 넣음 → 모노 파일 클립마다 +3.01 dB volume 필터(역할: mono->stereo upmix compensation)
- 플래시 s3: 범위 영상 영역(region) rect [0, 656, 1080, 608] @ [1080, 1920], 프레임 [224, 227]
...
- MLT 프로젝트를 melt 로 실제 렌더해 마스터 MP4 와 같은 시각 1초 격자로 비교: **통과**
  ...
  - 1초별 SSIM 분포: n=22, p10 0.995 / p50 0.998 / p90 0.998
  - 소리 RMS 포락선 상관 0.9961 (기준 ≥ 0.9), 초별 레벨 차 최대 0.74 dB
...
|---|---|---|---|---|---|
| 0 | 0.9981 | 0.251 | 0.04 | 통과 | 통과 |
| 1 | 0.9981 | 0.273 | 0.03 | 통과 | 통과 |
| 2 | 0.9982 | 0.27 | 0.02 | 통과 | 통과 |
| 3 | 0.9981 | 0.268 | 0.03 | 통과 | 통과 |
| 4 | 0.9981 | 0.26 | 0.01 | 통과 | 통과 |
| 5 | 0.9981 | 0.262 | 0.01 | 통과 | 통과 |
| 6 | 0.998 | 0.288 | -0.02 | 통과 | 통과 |
| 7 | 0.9981 | 0.317 | 0.12 | 통과 | 통과 |
| 8 | 0.9982 | 0.261 | 0.03 | 통과 | 통과 |
| 9 | 0.9982 | 0.264 | 0.02 | 통과 | 통과 |
| 10 | 0.9981 | 0.309 | 0.02 | 통과 | 통과 |
| 11 | 0.998 | 0.319 | 0.01 | 통과 | 통과 |
| 12 | 0.9939 | 1.88 | 0.02 | 통과 | 통과 |
| 13 | 0.9973 | 0.392 | 0.02 | 통과 | 통과 |
| 14 | 0.9961 | 0.429 | 0.02 | 통과 | 통과 |
| 15 | 0.9954 | 0.518 | 0.02 | 통과 | 통과 |
| 16 | 0.9974 | 0.455 | 0.03 | 통과 | 통과 |
| 17 | 0.9973 | 0.435 | 0.02 | 통과 | 통과 |
| 18 | 0.9972 | 0.415 | 0.02 | 통과 | 통과 |
| 19 | 0.9971 | 0.386 | 0.02 | 통과 | 통과 |
| 20 | 0.9945 | 0.496 | 0.1 | 통과 | 통과 |
| 21 | 0.9944 | 0.516 | 0.74 | 통과 | 통과 |
...
- 계획 단계 경고:
  - [bgm_section_start_s_override] plan.bgm.section_start_s=12.0s 가 프리셋 audio.bgm.section_start_s=0.0s(임시값·못 잼) 와 다릅니다: 같은 곡의 다른 구간/속도는 레퍼런스 음악과 일치가 아님(의도한 변경이면 requested_changes 로)
  ...
  - [provenance_missing] warehouse_id 없음: 출처 기록(창고 레코드)이 연결되지 않았습니다
  - [duration_unmeasured] 영상 길이 분포 미측정(못 잼, n=0, p10=None, p50=None, p90=None): 21.25s 의 적합성 판정 불가
  - [zoom_cuts_protected] 확대(zoom) 때문에 보호 영역 '왼쪽 남성 얼굴' 이 화면 밖으로 잘립니다
  - [trim_tail] 세그먼트 s4 가 마지막 의미(자막 c_sit4, 19.00s) 뒤로 2.25s 더 이어집니다 (> motion.trim.tail_after_meaning_s 0.25s): 의미가 끝난 꼬리는 자르기(중요한 동작이면 자막/사건으로 표시, 반응·마무리 구간이면 purpose 에 적기)
...
- plan sha256 `761fc723f7bd5160929d9020b6ee23fe77af5e4420001d0e41c60fa45b02fe75`
